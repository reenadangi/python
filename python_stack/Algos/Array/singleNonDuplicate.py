def singleNonDuplicate(nums):
    # because it is sorted array we can do binary search
    left=0
    right=len(nums)-1
    while left<right:
...
def singleNonDuplicateIII(nums):
#     EXPLANATION:-
...
print(singleNonDuplicateIII([1,1,2,2,3,3,4,5,5]))
